...
<span style="color: orange; padding-right: 10px">POST</span> /v1/posts/
...
```
{
  ...
  "description": "My First Video!",
  "media":"http://127.0.0.1:8000/media/video/1.mp4",
  "published_date":"2018-07-12T00:06:11.822005",
  "comments": []
}
```
...
<span style="color: blue; padding-right: 10px">PUT</span> /v1/posts/1/
